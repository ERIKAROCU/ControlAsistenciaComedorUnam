...
<body>
<h2>Gestion de justificacion de Postulaciones</h2><br><br>
<h4>2024 - 1</h4>
    ...
    <table>
        ...
        <tr>
            ...
            <td><input name="documento_identidad" id="documento_identidad" class="texto" readonly></td>
        </tr>
    </table>
    ...
    <script>
        function llenarCampos(
            ...
            document.getElementById('fut_postulacion').innerHTML = fut_postulacion === '1' ? '<a href="descarga_postulaciones/1_fut_postulacion.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('formato1').innerHTML = formato1 === '1' ? '<a href="descarga_postulaciones/2_formato1.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('formato2').innerHTML = formato2 === '1' ? '<a href="descarga_postulaciones/3_formato2.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('formato3').innerHTML = formato3 === '1' ? '<a href="descarga_postulaciones/4_formato3.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('formato4').innerHTML = formato4 === '1' ? '<a href="descarga_postulaciones/5_formato4.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('ficha_socioeconomica').innerHTML = ficha_socioeconomica === '1' ? '<a href="descarga_postulaciones/6_ficha_socioeconomica.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('copia_boleta_pago').innerHTML = copia_boleta_pago === '1' ? '<a href="descarga_postulaciones/7_boleta_pago.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('recibo_luz').innerHTML = recibo_luz === '1' ? '<a href="descarga_postulaciones/8_recibo_luz.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('croquis').innerHTML = croquis === '1' ? '<a href="descarga_postulaciones/9_croquis.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('recibo_alquiler').innerHTML = recibo_alquiler === '1' ? '<a href="descarga_postulaciones/10_recibo_alquiler.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('acta_orfandad_defuncion').innerHTML = acta_orfandad_defuncion === '1' ? '<a href="descarga_postulaciones/11_recibo_orfandad.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('carga_familiar').innerHTML = carga_familiar === '1' ? '<a href="descarga_postulaciones/12_carga_familiar.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('carnet_conadis').innerHTML = carnet_conadis === '1' ? '<a href="descarga_postulaciones/13_carnet_conadis.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('denuncia_policial_abandono_hogar').innerHTML = denuncia_policial_abandono_hogar === '1' ? '<a href="descarga_postulaciones/14_denuncia_policial.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('demanda_alimentos').innerHTML = demanda_alimentos === '1' ? '<a href="descarga_postulaciones/15_demanda_alimentos.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('pagos_deuda_bancaria').innerHTML = pagos_deuda_bancaria === '1' ? '<a href="descarga_postulaciones/16_deuda_bancaria.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
            document.getElementById('separacion_municipalidad').innerHTML = separacion_municipalidad === '1' ? '<a href="descarga_postulaciones/17_separacion_municipalidad.php?id=' + id_registro + '">Descargar</a>' : 'Archivo no disponible';
        }
    </script>
</body>
</html>
