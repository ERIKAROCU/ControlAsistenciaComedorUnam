...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT dni_estudiante FROM login_estudiantes WHERE codigo_recuperacion = '$codigo_recuperacion'";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql_update = "UPDATE login_estudiantes SET contrasena = '$hashed_password', codigo_recuperacion = NULL WHERE dni_estudiante = '$dni_estudiante'";
        ...
        header("Location: ../html/formulario_nueva_contrasena.html?error=1");
    }
